	...
	match cur_day:
		1:
			...
			for i in range(0, num_items):
				value_array.append(randi_range(2, 5))
			print(value_array.size())
			wait_time = 4.0
		2:
			num_items = 7
		...
		4:
			...
			for i in range(0, num_items):
				value_array.append(randi_range(3, 6))
			wait_time = 6.5
		5:
			num_items = 12
		...
		7:
			...
			for i in range(0, num_items):
				value_array.append(randi_range(4, 7))
			wait_time = 6.5
		8:
			num_items = 15
		...
		10:
			...
			for i in range(0, num_items):
				value_array.append(randi_range(5, 8))
			wait_time = 7.0
		11:
			num_items = 15
		...
		13:
			...
			for i in range(0, num_items):
				value_array.append(randi_range(6, 9))
			wait_time = 4.0
		14:
			num_items = 20
		...
		15:
			...
			for i in range(0, num_items):
				value_array.append(randi_range(100, 1000))
			wait_time = 5.0
