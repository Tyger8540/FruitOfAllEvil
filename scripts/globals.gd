...
const BLENDER_APPLE = preload("res://final_art/AppleInBlender.png")
const CUP_APPLE2 = preload("res://final_art/AppleBlended.png")

const ORANGE = preload("res://final_art/Orange.png")
const CHOPPED_ORANGE = preload("res://final_art/Orange_Chopped.png")
const BLENDER_ORANGE = preload("res://final_art/OrangeInBlender.png")
const CUP_ORANGE2 = preload("res://final_art/OrangeBlended.png")

const BANANA = preload("res://final_art/Banana.png")
const CHOPPED_BANANA = preload("res://final_art/Banana_Chopped.png")
const BLENDER_BANANA = preload("res://final_art/BananaInBlender.png")
const CUP_BANANA2 = preload("res://final_art/BananaBlended.png")
...
const BLENDER_BLUEBERRIES = preload("res://final_art/BlueberryInBlender.png")
const CUP_BLUEBERRIES = preload("res://final_art/BlueberryBlended.png")

const GRAPES = preload("res://final_art/Grape.png")
const CHOPPED_GRAPES = preload("res://final_art/Grape_Chopped.png")
const BLENDER_GRAPES = preload("res://final_art/GrapeInBlender.png")
const CUP_GRAPES = preload("res://final_art/GrapeBlended.png")

const BLENDED_CUP = preload("res://final_art/BlendedCup.png")
